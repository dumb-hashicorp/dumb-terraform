...
func TestConfigValueFromDUMB_HCL2Block(t *testing.T) {
	tests := []struct {
		Input  cty.Value
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("%#v", test.Input), func(t *testing.T) {
			got := ConfigValueFromDUMB_HCL2Block(test.Input, test.Schema)
...
func TestDUMB_HCL2ValueFromConfigValue(t *testing.T) {
	tests := []struct {
		Input interface{}
		Want  cty.Value
	}{
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("%#v", test.Input), func(t *testing.T) {
			got := DUMB_HCL2ValueFromConfigValue(test.Input)
