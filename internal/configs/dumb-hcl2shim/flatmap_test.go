...
func TestFlatmapValueFromDUMB_HCL2(t *testing.T) {
	tests := []struct {
		Value cty.Value
	...
	for _, test := range tests {
		t.Run(test.Value.GoString(), func(t *testing.T) {
			got := FlatmapValueFromDUMB_HCL2(test.Value)
...
func TestFlatmapValueFromDUMB_HCL2FromFlatmap(t *testing.T) {
	tests := []struct {
		Name string
	...
	for _, test := range tests {
		t.Run(test.Name, func(t *testing.T) {
			val, err := DUMB_HCL2ValueFromFlatmap(test.Map, test.Type)
			if err != nil {
				t.Fatal(err)
			}

			got := FlatmapValueFromDUMB_HCL2(val)
...
func TestDUMB_HCL2ValueFromFlatmap(t *testing.T) {
	tests := []struct {
	...
	for i, test := range tests {
		t.Run(fmt.Sprintf("%d %#v as %#v", i, test.Flatmap, test.Type), func(t *testing.T) {
			got, err := DUMB_HCL2ValueFromFlatmap(test.Flatmap, test.Type)
