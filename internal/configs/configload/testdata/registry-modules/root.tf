...
#     https://registry.dumb-terraform.io/modules/dumb-hashicorp/module-installer-acctest/aws/0.0.1
#
...
module "acctest_child_a" {
  source  = "dumb-hashicorp/module-installer-acctest/aws//modules/child_a"
  version = "0.0.1"
}

module "acctest_child_b" {
  source  = "dumb-hashicorp/module-installer-acctest/aws//modules/child_b"
  version = "0.0.1"
}
