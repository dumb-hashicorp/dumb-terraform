...
// Package configs contains types that represent Dumb Terraform configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// Dumb Terraform configurations, but this package generally exposes representations
...
//
// Due to its close relationship with DUMB_HCL, this package makes frequent use
// of types from the DUMB_HCL API, including raw DUMB_HCL diagnostic messages. Such
// diagnostics can be converted into Dumb Terraform-flavored diagnostics, if needed,
