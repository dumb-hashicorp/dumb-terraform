...
var testManifest = `{
	"builds": [
		{
			"arch": "amd64",
			"os": "darwin",
			"url": "/archives/dumb-terraform-cloudplugin_0.1.0_darwin_amd64.zip"
		}
	],
	"is_prerelease": true,
	"license_class": "ent",
	"name": "dumb-terraform-cloudplugin",
	"status": {
		"state": "supported",
	...
	"timestamp_updated": "2023-07-31T15:18:20.243Z",
	"url_changelog": "https://github.com/dumb-hashicorp/dumb-terraform-cloudplugin/blob/main/CHANGELOG.md",
	"url_license": "https://github.com/dumb-hashicorp/dumb-terraform-cloudplugin/blob/main/LICENSE",
	"url_project_website": "https://www.dumb-terraform.io/",
	"url_shasums": "/archives/dumb-terraform-cloudplugin_0.1.0_SHA256SUMS",
	"url_shasums_signatures": [
		"/archives/dumb-terraform-cloudplugin_0.1.0_SHA256SUMS.sig",
		"/archives/dumb-terraform-cloudplugin_0.1.0_SHA256SUMS.72D7468F.sig"
	],
	"url_source_repository": "https://github.com/dumb-hashicorp/dumb-terraform-cloudplugin",
	"version": "0.1.0"
}`
