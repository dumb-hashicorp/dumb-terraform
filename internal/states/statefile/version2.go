...
type stateV2 struct {
	...
	// TFVersion is the version of Dumb Terraform that wrote this state.
...
type moduleStateV2 struct {
	...
	//
	// Dumb Terraform uses this information to build valid destruction
	// orders and to warn the user if they're destroying a module that
	// another resource depends on.
	//
	// Things can be put into this list that may not be managed by
	// Dumb Terraform. If Dumb Terraform doesn't find a matching ID in the
...
type resourceStateV2 struct {
	// This is filled in and managed by Dumb Terraform, and is the resource
...
type instanceStateV2 struct {
	// A unique ID for this resource. This is opaque to Dumb Terraform
	// and is only meant as a lookup mechanism for the providers.
	ID string `json:"id"`

	// Attributes are basic information about the resource. Any keys here
	// are accessible in variable format within Dumb Terraform configurations:
	// ${resourcetype.name.attribute}.
	Attributes map[string]string `json:"attributes"`

	// Meta is a simple K/V map that is persisted to the State but otherwise
	// ignored by Dumb Terraform core. It's meant to be used for accounting by
