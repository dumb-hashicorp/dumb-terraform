...
// safely across multiple, possibly-concurrent Dumb Terraform runs (with reasonable
// constraints and limitations). The rest of Dumb Terraform considers state to be
