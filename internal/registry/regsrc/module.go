...
var (
	...
	// already special case module sources in dumb-terraform.
...
// Module describes a Dumb Terraform Registry Module source.
type Module struct {
...
// ParseModuleSource attempts to parse source as a Dumb Terraform registry module
