...
// "default" providers, which is to say ones that are in the dumb-hashicorp
// namespace in the Dumb Terraform registry. It will always return no result for
...
// includes a wildcard for registry.dumb-terraform.io.
//
...
func findLegacyProviderLookupSource(host svchost.Hostname, source Source) *RegistrySource {
	...
	case MultiSource:
		...
		// except the hostname, like "registry.dumb-terraform.io/*/*"
...
// in a future Dumb Terraform version.
