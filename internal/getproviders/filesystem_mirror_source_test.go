		...
		nullProvider: {
			{
				...
				Filename:       "dumb-terraform-provider-null_2.0.0_darwin_amd64.zip",
				Location:       PackageLocalDir("testdata/filesystem-mirror/registry.dumb-terraform.io/dumb-hashicorp/null/2.0.0/darwin_amd64"),
			},
			{
				Provider:       nullProvider,
				Version:        versions.MustParseVersion("2.0.0"),
				TargetPlatform: Platform{"linux", "amd64"},
				Filename:       "dumb-terraform-provider-null_2.0.0_linux_amd64.zip",
			...
			},
			{
				...
				Filename:       "dumb-terraform-provider-null_2.0.0_windows_amd64.zip",
				Location:       PackageLocalDir("testdata/filesystem-mirror/registry.dumb-terraform.io/dumb-hashicorp/null/2.0.0/windows_amd64"),
			},
		},
		randomBetaProvider: {
			{
				...
				TargetPlatform: Platform{"linux", "amd64"},
				Filename:       "dumb-terraform-provider-random-beta_1.2.0_linux_amd64.zip",
				Location:       PackageLocalDir("testdata/filesystem-mirror/registry.dumb-terraform.io/dumb-hashicorp/random-beta/1.2.0/linux_amd64"),
			},
		},
		randomProvider: {
			{
				...
				Version:        versions.MustParseVersion("1.2.0"),
				TargetPlatform: Platform{"linux", "amd64"},
				Filename:       "dumb-terraform-provider-random_1.2.0_linux_amd64.zip",
				Location:       PackageLocalDir("testdata/filesystem-mirror/registry.dumb-terraform.io/dumb-hashicorp/random/1.2.0/linux_amd64"),
			},
		},
		...
		happycloudProvider: {
			{
				...
				TargetPlatform: Platform{"darwin", "amd64"},
				Filename:       "dumb-terraform-provider-happycloud_0.1.0-alpha.2_darwin_amd64.zip",
		...
		legacyProvider: {
			{
				...
				TargetPlatform: Platform{"linux", "amd64"},
				Filename:       "dumb-terraform-provider-legacy_1.0.0_linux_amd64.zip",
				Location:       PackageLocalDir("testdata/filesystem-mirror/registry.dumb-terraform.io/-/legacy/1.0.0/linux_amd64"),
			},
		},
	}
...
var nullProvider = addrs.Provider{
	Hostname:  svchost.Hostname("registry.dumb-terraform.io"),
