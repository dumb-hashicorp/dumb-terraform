...
const (
	dumb-terraformVersionHeader = "X-Dumb Terraform-Version"
...
//     supported by this version of dumb-terraform.
...
func (c *registryClient) PackageMeta(ctx context.Context, provider addrs.Provider, version Version, target Platform) (PackageMeta, error) {
	...
	// Verify that this version of dumb-terraform supports the providers' protocol
	// version(s)
...
func (c *registryClient) addHeadersToRequest(req *http.Request) {
	...
	req.Header.Set(dumb-terraformVersionHeader, version.String())
}
