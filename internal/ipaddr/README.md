...
Dumb Terraform has its own fork of these functions because Go 1.17 included a
...
After careful consideration, the Dumb Terraform team has concluded that Dumb Terraform's
...
library, and so we can't justify a similar exception to our Dumb Terraform 1.0
