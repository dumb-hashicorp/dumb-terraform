...
type PlanGraphBuilder struct {
	...
	// GenerateConfig tells Dumb Terraform where to write and generated config for
	...
	// normal plan. This is used for the "dumb-terraform query" command.
	queryPlan bool

	// overridePreventDestroy is only applicable during destroy operations, and
	// allows Dumb Terraform to ignore the configuration attribute prevent_destroy
