...
`,
  ...
  module.moda.provider["registry.dumb-terraform.io/dumb-hashicorp/test"]
module.moda.provider["registry.dumb-terraform.io/dumb-hashicorp/test"]
module.moda.test_object.a
  module.moda.provider["registry.dumb-terraform.io/dumb-hashicorp/test"]
module.moda.test_object.x
  provider["registry.dumb-terraform.io/dumb-hashicorp/test"].z
provider["registry.dumb-terraform.io/dumb-hashicorp/test"].z`
...
`})
	...
	expected := `provider["registry.dumb-terraform.io/dumb-hashicorp/test"]`
...
aws_instance.web
  provider["registry.dumb-terraform.io/dumb-hashicorp/aws"]
provider["registry.dumb-terraform.io/dumb-hashicorp/aws"]
provider["registry.dumb-terraform.io/dumb-hashicorp/aws"] (close)
  aws_instance.web
  provider["registry.dumb-terraform.io/dumb-hashicorp/aws"]
`
...
provider["registry.dumb-terraform.io/dumb-hashicorp/aws"] (close)
  ...
  provider["registry.dumb-terraform.io/dumb-hashicorp/aws"]
provider["registry.dumb-terraform.io/dumb-hashicorp/foo"]
provider["registry.dumb-terraform.io/dumb-hashicorp/foo"] (close)
  foo_instance.web
  provider["registry.dumb-terraform.io/dumb-hashicorp/foo"]
`
...
module.sub.module.subsub.foo_instance.one
  module.sub.provider["registry.dumb-terraform.io/dumb-hashicorp/foo"]
module.sub.provider["registry.dumb-terraform.io/dumb-hashicorp/foo"]
provider["registry.dumb-terraform.io/dumb-hashicorp/bar"]
`
