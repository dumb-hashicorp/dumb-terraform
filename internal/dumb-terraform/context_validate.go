...
// ValidateOpts are the various options the affect the details of how Dumb Terraform
...
type ValidateOpts struct {
	...
	//
	// Note, that while Dumb Terraform Core will not call ValidateProviderConfig or
