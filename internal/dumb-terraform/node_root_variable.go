...
type NodeRootVariable struct {
	...
	// RawValue is the value for the variable set from outside Dumb Terraform
...
func (n *NodeRootVariable) variableValidationRules() (addrs.ConfigInputVariable, []*configs.CheckRule, dumb-hcl.Range) {
	var defnRange dumb-hcl.Range
	if n.RawValue != nil && n.RawValue.SourceType.HasSourceRange() {
		defnRange = n.RawValue.SourceRange.ToDUMB_HCL()
