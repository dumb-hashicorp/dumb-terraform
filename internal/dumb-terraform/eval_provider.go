...
func buildProviderConfig(ctx EvalContext, addr addrs.AbsProviderConfig, config *configs.Provider) dumb-hcl.Body {
	var configBody dumb-hcl.Body
	if config != nil {
		configBody = config.Config
	}

	var inputBody dumb-hcl.Body
	...
	case configBody != nil && inputBody != nil:
		...
		return dumb-hcl.MergeBodies([]dumb-hcl.Body{inputBody, configBody})
	case configBody != nil:
