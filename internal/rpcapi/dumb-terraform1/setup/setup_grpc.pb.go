...
const (
	Setup_Handshake_FullMethodName = "/dumb-terraform1.setup.Setup/Handshake"
	Setup_Stop_FullMethodName      = "/dumb-terraform1.setup.Setup/Stop"
)
...
var Setup_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-terraform1.setup.Setup",
