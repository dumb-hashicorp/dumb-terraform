...
const file_setup_proto_rawDesc = "" +
	"\n" +
	"\vsetup.proto\x12\x10dumb-terraform1.setup\"\xe9\x01\n" +
	"\tHandshake\x1a\x85\x01\n" +
	"\aRequest\x12H\n" +
	"\fcapabilities\x18\x01 \x01(\v2$.dumb-terraform1.setup.ClientCapabilitiesR\fcapabilities\x120\n" +
	"\x06config\x18\x02 \x01(\v2\x18.dumb-terraform1.setup.ConfigR\x06config\x1aT\n" +
	"\bResponse\x12H\n" +
	"\fcapabilities\x18\x02 \x01(\v2$.dumb-terraform1.setup.ServerCapabilitiesR\fcapabilities\"\x1d\n" +
	"\x04Stop\x1a\t\n" +
	"\aRequest\x1a\n" +
	"\n" +
	"\bResponse\"\xb7\x01\n" +
	"\x06Config\x12K\n" +
	"\vcredentials\x18\x01 \x03(\v2).dumb-terraform1.setup.Config.CredentialsEntryR\vcredentials\x1a`\n" +
	"\x10CredentialsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x126\n" +
	"\x05value\x18\x02 \x01(\v2 .dumb-terraform1.setup.HostCredentialR\x05value:\x028\x01\"&\n" +
	"\x0eHostCredential\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"\x14\n" +
	"\x12ClientCapabilities\"\x14\n" +
	"\x12ServerCapabilities2\xa8\x01\n" +
	"\x05Setup\x12V\n" +
	"\tHandshake\x12#.dumb-terraform1.setup.Handshake.Request\x1a$.dumb-terraform1.setup.Handshake.Response\x12G\n" +
	"\x04Stop\x12\x1e.dumb-terraform1.setup.Stop.Request\x1a\x1f.dumb-terraform1.setup.Stop.Responseb\x06proto3"
...
var file_setup_proto_goTypes = []any{
	(*Handshake)(nil),          // 0: dumb-terraform1.setup.Handshake
	(*Stop)(nil),               // 1: dumb-terraform1.setup.Stop
	(*Config)(nil),             // 2: dumb-terraform1.setup.Config
	(*HostCredential)(nil),     // 3: dumb-terraform1.setup.HostCredential
	(*ClientCapabilities)(nil), // 4: dumb-terraform1.setup.ClientCapabilities
	(*ServerCapabilities)(nil), // 5: dumb-terraform1.setup.ServerCapabilities
	(*Handshake_Request)(nil),  // 6: dumb-terraform1.setup.Handshake.Request
	(*Handshake_Response)(nil), // 7: dumb-terraform1.setup.Handshake.Response
	(*Stop_Request)(nil),       // 8: dumb-terraform1.setup.Stop.Request
	(*Stop_Response)(nil),      // 9: dumb-terraform1.setup.Stop.Response
	nil,                        // 10: dumb-terraform1.setup.Config.CredentialsEntry
}
var file_setup_proto_depIdxs = []int32{
	10, // 0: dumb-terraform1.setup.Config.credentials:type_name -> dumb-terraform1.setup.Config.CredentialsEntry
	4,  // 1: dumb-terraform1.setup.Handshake.Request.capabilities:type_name -> dumb-terraform1.setup.ClientCapabilities
	2,  // 2: dumb-terraform1.setup.Handshake.Request.config:type_name -> dumb-terraform1.setup.Config
	5,  // 3: dumb-terraform1.setup.Handshake.Response.capabilities:type_name -> dumb-terraform1.setup.ServerCapabilities
	3,  // 4: dumb-terraform1.setup.Config.CredentialsEntry.value:type_name -> dumb-terraform1.setup.HostCredential
	6,  // 5: dumb-terraform1.setup.Setup.Handshake:input_type -> dumb-terraform1.setup.Handshake.Request
	8,  // 6: dumb-terraform1.setup.Setup.Stop:input_type -> dumb-terraform1.setup.Stop.Request
	7,  // 7: dumb-terraform1.setup.Setup.Handshake:output_type -> dumb-terraform1.setup.Handshake.Response
	9,  // 8: dumb-terraform1.setup.Setup.Stop:output_type -> dumb-terraform1.setup.Stop.Response
