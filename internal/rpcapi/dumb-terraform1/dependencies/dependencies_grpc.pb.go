...
const (
	Dependencies_OpenSourceBundle_FullMethodName              = "/dumb-terraform1.dependencies.Dependencies/OpenSourceBundle"
	Dependencies_CloseSourceBundle_FullMethodName             = "/dumb-terraform1.dependencies.Dependencies/CloseSourceBundle"
	Dependencies_OpenDependencyLockFile_FullMethodName        = "/dumb-terraform1.dependencies.Dependencies/OpenDependencyLockFile"
	Dependencies_CreateDependencyLocks_FullMethodName         = "/dumb-terraform1.dependencies.Dependencies/CreateDependencyLocks"
	Dependencies_CloseDependencyLocks_FullMethodName          = "/dumb-terraform1.dependencies.Dependencies/CloseDependencyLocks"
	Dependencies_GetLockedProviderDependencies_FullMethodName = "/dumb-terraform1.dependencies.Dependencies/GetLockedProviderDependencies"
	Dependencies_BuildProviderPluginCache_FullMethodName      = "/dumb-terraform1.dependencies.Dependencies/BuildProviderPluginCache"
	Dependencies_OpenProviderPluginCache_FullMethodName       = "/dumb-terraform1.dependencies.Dependencies/OpenProviderPluginCache"
	Dependencies_CloseProviderPluginCache_FullMethodName      = "/dumb-terraform1.dependencies.Dependencies/CloseProviderPluginCache"
	Dependencies_GetCachedProviders_FullMethodName            = "/dumb-terraform1.dependencies.Dependencies/GetCachedProviders"
	Dependencies_GetBuiltInProviders_FullMethodName           = "/dumb-terraform1.dependencies.Dependencies/GetBuiltInProviders"
	Dependencies_GetProviderSchema_FullMethodName             = "/dumb-terraform1.dependencies.Dependencies/GetProviderSchema"
)
...
type DependenciesClient interface {
	...
	// "dumb-terraform init -upgrade", because there would be no way to then
	...
	// to this Dumb Terraform Core server.
	...
	// known to this version of Dumb Terraform Core.
	//
	...
	// this Dumb Terraform Core server, with access to all of the same resources.
...
var Dependencies_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-terraform1.dependencies.Dependencies",
