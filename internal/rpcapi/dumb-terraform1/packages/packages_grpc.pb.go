...
const (
	Packages_ProviderPackageVersions_FullMethodName = "/dumb-terraform1.packages.Packages/ProviderPackageVersions"
	Packages_FetchProviderPackage_FullMethodName    = "/dumb-terraform1.packages.Packages/FetchProviderPackage"
	Packages_ModulePackageVersions_FullMethodName   = "/dumb-terraform1.packages.Packages/ModulePackageVersions"
	Packages_ModulePackageSourceAddr_FullMethodName = "/dumb-terraform1.packages.Packages/ModulePackageSourceAddr"
	Packages_FetchModulePackage_FullMethodName      = "/dumb-terraform1.packages.Packages/FetchModulePackage"
)
...
//
// The Packages service provides helper functions for retrieving Dumb Terraform
...
var Packages_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-terraform1.packages.Packages",
