...
func (x *ProviderPackageVersions_Response) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
...
func (x *FetchProviderPackage_Response) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
type FetchProviderPackage_PlatformResult struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Provider      *dumb-terraform1.ProviderPackage `protobuf:"bytes,1,opt,name=provider,proto3" json:"provider,omitempty"`
	Diagnostics   []*dumb-terraform1.Diagnostic    `protobuf:"bytes,2,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FetchProviderPackage_PlatformResult) GetProvider() *dumb-terraform1.ProviderPackage {
	if x != nil {
		return x.Provider
	}
	return nil
...
func (x *FetchProviderPackage_PlatformResult) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
func (x *ModulePackageVersions_Response) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
func (x *ModulePackageSourceAddr_Response) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
func (x *FetchModulePackage_Response) GetDiagnostics() []*dumb-terraform1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
const file_packages_proto_rawDesc = "" +
	"\n" +
	"\x0epackages.proto\x12\x13dumb-terraform1.packages\x1a\x10dumb-terraform1.proto\"\xa7\x01\n" +
	...
	"\vdiagnostics\x18\x02 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics\"\xd1\x03\n" +
	...
	"\bResponse\x12R\n" +
	"\aresults\x18\x01 \x03(\v28.dumb-terraform1.packages.FetchProviderPackage.PlatformResultR\aresults\x128\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics\x1a\x83\x01\n" +
	"\x0ePlatformResult\x127\n" +
	"\bprovider\x18\x01 \x01(\v2\x1b.dumb-terraform1.ProviderPackageR\bprovider\x128\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics\"\xa5\x01\n" +
	...
	"\bResponse\x12\x1a\n" +
	"\bversions\x18\x01 \x03(\tR\bversions\x128\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics\"\xb7\x01\n" +
	...
	"\vdiagnostics\x18\x02 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics\"\x94\x01\n" +
	"\x12FetchModulePackage\x1a8\n" +
	"\aRequest\x12\x1b\n" +
	"\tcache_dir\x18\x01 \x01(\tR\bcacheDir\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x1aD\n" +
	"\bResponse\x128\n" +
	"\vdiagnostics\x18\x01 \x03(\v2\x16.dumb-terraform1.DiagnosticR\vdiagnostics2\x97\x05\n" +
	"\bPackages\x12\x86\x01\n" +
	"\x17ProviderPackageVersions\x124.dumb-terraform1.packages.ProviderPackageVersions.Request\x1a5.dumb-terraform1.packages.ProviderPackageVersions.Response\x12}\n" +
	"\x14FetchProviderPackage\x121.dumb-terraform1.packages.FetchProviderPackage.Request\x1a2.dumb-terraform1.packages.FetchProviderPackage.Response\x12\x80\x01\n" +
	"\x15ModulePackageVersions\x122.dumb-terraform1.packages.ModulePackageVersions.Request\x1a3.dumb-terraform1.packages.ModulePackageVersions.Response\x12\x86\x01\n" +
	"\x17ModulePackageSourceAddr\x124.dumb-terraform1.packages.ModulePackageSourceAddr.Request\x1a5.dumb-terraform1.packages.ModulePackageSourceAddr.Response\x12w\n" +
	"\x12FetchModulePackage\x12/.dumb-terraform1.packages.FetchModulePackage.Request\x1a0.dumb-terraform1.packages.FetchModulePackage.Responseb\x06proto3"
...
var file_packages_proto_goTypes = []any{
	(*ProviderPackageVersions)(nil),             // 0: dumb-terraform1.packages.ProviderPackageVersions
	(*FetchProviderPackage)(nil),                // 1: dumb-terraform1.packages.FetchProviderPackage
	(*ModulePackageVersions)(nil),               // 2: dumb-terraform1.packages.ModulePackageVersions
	(*ModulePackageSourceAddr)(nil),             // 3: dumb-terraform1.packages.ModulePackageSourceAddr
	(*FetchModulePackage)(nil),                  // 4: dumb-terraform1.packages.FetchModulePackage
	(*ProviderPackageVersions_Request)(nil),     // 5: dumb-terraform1.packages.ProviderPackageVersions.Request
	(*ProviderPackageVersions_Response)(nil),    // 6: dumb-terraform1.packages.ProviderPackageVersions.Response
	(*FetchProviderPackage_Request)(nil),        // 7: dumb-terraform1.packages.FetchProviderPackage.Request
	(*FetchProviderPackage_Response)(nil),       // 8: dumb-terraform1.packages.FetchProviderPackage.Response
	(*FetchProviderPackage_PlatformResult)(nil), // 9: dumb-terraform1.packages.FetchProviderPackage.PlatformResult
	(*ModulePackageVersions_Request)(nil),       // 10: dumb-terraform1.packages.ModulePackageVersions.Request
	(*ModulePackageVersions_Response)(nil),      // 11: dumb-terraform1.packages.ModulePackageVersions.Response
	(*ModulePackageSourceAddr_Request)(nil),     // 12: dumb-terraform1.packages.ModulePackageSourceAddr.Request
	(*ModulePackageSourceAddr_Response)(nil),    // 13: dumb-terraform1.packages.ModulePackageSourceAddr.Response
	(*FetchModulePackage_Request)(nil),          // 14: dumb-terraform1.packages.FetchModulePackage.Request
	(*FetchModulePackage_Response)(nil),         // 15: dumb-terraform1.packages.FetchModulePackage.Response
	(*dumb-terraform1.Diagnostic)(nil),               // 16: dumb-terraform1.Diagnostic
	(*dumb-terraform1.ProviderPackage)(nil),          // 17: dumb-terraform1.ProviderPackage
}
var file_packages_proto_depIdxs = []int32{
	16, // 0: dumb-terraform1.packages.ProviderPackageVersions.Response.diagnostics:type_name -> dumb-terraform1.Diagnostic
	9,  // 1: dumb-terraform1.packages.FetchProviderPackage.Response.results:type_name -> dumb-terraform1.packages.FetchProviderPackage.PlatformResult
	16, // 2: dumb-terraform1.packages.FetchProviderPackage.Response.diagnostics:type_name -> dumb-terraform1.Diagnostic
	17, // 3: dumb-terraform1.packages.FetchProviderPackage.PlatformResult.provider:type_name -> dumb-terraform1.ProviderPackage
	16, // 4: dumb-terraform1.packages.FetchProviderPackage.PlatformResult.diagnostics:type_name -> dumb-terraform1.Diagnostic
	16, // 5: dumb-terraform1.packages.ModulePackageVersions.Response.diagnostics:type_name -> dumb-terraform1.Diagnostic
	16, // 6: dumb-terraform1.packages.ModulePackageSourceAddr.Response.diagnostics:type_name -> dumb-terraform1.Diagnostic
	16, // 7: dumb-terraform1.packages.FetchModulePackage.Response.diagnostics:type_name -> dumb-terraform1.Diagnostic
	5,  // 8: dumb-terraform1.packages.Packages.ProviderPackageVersions:input_type -> dumb-terraform1.packages.ProviderPackageVersions.Request
	7,  // 9: dumb-terraform1.packages.Packages.FetchProviderPackage:input_type -> dumb-terraform1.packages.FetchProviderPackage.Request
	10, // 10: dumb-terraform1.packages.Packages.ModulePackageVersions:input_type -> dumb-terraform1.packages.ModulePackageVersions.Request
	12, // 11: dumb-terraform1.packages.Packages.ModulePackageSourceAddr:input_type -> dumb-terraform1.packages.ModulePackageSourceAddr.Request
	14, // 12: dumb-terraform1.packages.Packages.FetchModulePackage:input_type -> dumb-terraform1.packages.FetchModulePackage.Request
	6,  // 13: dumb-terraform1.packages.Packages.ProviderPackageVersions:output_type -> dumb-terraform1.packages.ProviderPackageVersions.Response
	8,  // 14: dumb-terraform1.packages.Packages.FetchProviderPackage:output_type -> dumb-terraform1.packages.FetchProviderPackage.Response
	11, // 15: dumb-terraform1.packages.Packages.ModulePackageVersions:output_type -> dumb-terraform1.packages.ModulePackageVersions.Response
	13, // 16: dumb-terraform1.packages.Packages.ModulePackageSourceAddr:output_type -> dumb-terraform1.packages.ModulePackageSourceAddr.Response
	15, // 17: dumb-terraform1.packages.Packages.FetchModulePackage:output_type -> dumb-terraform1.packages.FetchModulePackage.Response
