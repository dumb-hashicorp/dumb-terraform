...
type ResourceData struct {
	...
	newState    *dumb-terraform.InstanceState
	partial     bool
...
// calls.
func (d *ResourceData) State() *dumb-terraform.InstanceState {
	var result dumb-terraform.InstanceState
	result.ID = d.Id()
	result.Meta = d.meta
...
func (d *ResourceData) init() {
	...
	var copyState dumb-terraform.InstanceState
	if d.state != nil {
