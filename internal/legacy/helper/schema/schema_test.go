...
func TestSchemaMap_Diff(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"availability_zone": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         "foo",
						RequiresNew: true,
					},
...

		{
			...
			Config: map[string]interface{}{
				"availability_zone": dumb-hcl2shim.UnknownVariableValue,
			},
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"availability_zone": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         dumb-hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
				},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"port": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         "27",
						RequiresNew: true,
					},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"ports.#": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "3",
					},
					"ports.0": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"ports.1": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "2",
					},
					"ports.2": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "5",
					},
				},
...

		{
			...
			Config: map[string]interface{}{
				"ports": []interface{}{1, dumb-hcl2shim.UnknownVariableValue, 5},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"config.#": &dumb-terraform.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},

					"config.0.name": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "hello",
					},

					"config.0.rules.#": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						NewComputed: true,
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"ports.5": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "5",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"ingress.#": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"ingress.0.from": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "8080",
					},
				},
		...
		/* TODO
		{
			...
			Diff: &dumb-terraform.ResourceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"availability_zone": &dumb-terraform.ResourceAttrDiff{
						Old:         "foo",
						NewComputed: true,
		...
		*/

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"config_vars.%": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},

					"config_vars.bar": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"config_vars.foo": &dumb-terraform.ResourceAttrDiff{
						Old:        "bar",
						NewRemoved: true,
					},
					"config_vars.bar": &dumb-terraform.ResourceAttrDiff{
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"vars.foo": &dumb-terraform.ResourceAttrDiff{
						Old:        "bar",
						New:        "",
						NewRemoved: true,
					},
					"vars.bar": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"config_vars.0.foo": &dumb-terraform.ResourceAttrDiff{
						Old:        "bar",
						NewRemoved: true,
					},
					"config_vars.0.bar": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"config_vars.0.%": &dumb-terraform.ResourceAttrDiff{
						Old: "2",
						New: "0",
					},
					"config_vars.0.foo": &dumb-terraform.ResourceAttrDiff{
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"address": &dumb-terraform.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						NewComputed: true,
					},
...

		{
			...
			Config: map[string]interface{}{
				"instances": []interface{}{dumb-hcl2shim.UnknownVariableValue},
			},

			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"instances.#": &dumb-terraform.ResourceAttrDiff{
						NewComputed: true,
					},
				},
			},
...

		{
			...
			Config: map[string]interface{}{
				"route": []interface{}{
					map[string]interface{}{
						"index":   "1",
						"gateway": dumb-hcl2shim.UnknownVariableValue,
					},
				},
			},
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"route.#": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"route.~1.index": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"route.~1.gateway": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         dumb-hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
			...
			Config: map[string]interface{}{
				"route": []interface{}{
					map[string]interface{}{
						"index": "1",
						"gateway": []interface{}{
							dumb-hcl2shim.UnknownVariableValue,
						},
					},
				},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"vars.%": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						NewComputed: true,
					},
				},
...

		{
			...
			Config: map[string]interface{}{
				"vars": map[string]interface{}{
					"bar": dumb-hcl2shim.UnknownVariableValue,
				},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"some_threshold": &dumb-terraform.ResourceAttrDiff{
						Old: "567.8",
						New: "12.34",
					},
				},
		...
		{
			Name: "https://github.com/dumb-hashicorp/dumb-terraform/issues/824",
			Schema: map[string]*Schema{
				"block_device": &Schema{
					Type:     TypeSet,
					Optional: true,
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"instances.3": &dumb-terraform.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						NewRemoved:  true,
						RequiresNew: true,
...

		{
			...
			Config: map[string]interface{}{
				"ports": []interface{}{1, dumb-hcl2shim.UnknownVariableValue},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"route.1.gateway-name": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "hello",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"service_account.#": &dumb-terraform.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},
					"service_account.0.scopes.#": &dumb-terraform.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},
					"service_account.0.scopes.123": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         "123!",
						NewExtra:    "123",
						RequiresNew: true,
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"instances.2": &dumb-terraform.ResourceAttrDiff{
						Old:         "22",
						New:         "",
						NewRemoved:  true,
						RequiresNew: true,
					...
					"instances.4": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         "4444",
						RequiresNew: true,
					},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"one": &dumb-terraform.ResourceAttrDiff{
						Old: "false",
						New: "true",
					},
					"two": &dumb-terraform.ResourceAttrDiff{
						Old: "true",
						New: "false",
					},
					"three": &dumb-terraform.ResourceAttrDiff{
						Old:        "true",
						New:        "false",
						NewRemoved: true,
					},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"ports.4": &dumb-terraform.ResourceAttrDiff{
						Old:         "4",
						New:         "0",
						NewRemoved:  true,
						RequiresNew: true,
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"description": &dumb-terraform.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						RequiresNew: true,
						NewRemoved:  true,
...

		{
			...
			Config: map[string]interface{}{
				"ports": []interface{}{dumb-hcl2shim.UnknownVariableValue, 2, 1},
			},
...

		{
			...
			Config: map[string]interface{}{
				"config": []interface{}{dumb-hcl2shim.UnknownVariableValue, dumb-hcl2shim.UnknownVariableValue},
			},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"ami_id": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "foo",
					},
					"instance_id": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "bar",
					},
				},
...

		{
			...
			Diff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"etag": &dumb-terraform.ResourceAttrDiff{
						Old: "foo",
						New: "bar",
					},
					"version_id": &dumb-terraform.ResourceAttrDiff{
						Old:         "1",
						New:         "",
						NewComputed: true,
					},
	...
	for i, tc := range cases {
		t.Run(fmt.Sprintf("%d-%s", i, tc.Name), func(t *testing.T) {
			c := dumb-terraform.NewResourceConfigRaw(tc.Config)
...
func TestSchemaMap_DiffSuppress(t *testing.T) {
	cases := map[string]struct {
		...
		State        *dumb-terraform.InstanceState
		Config       map[string]interface{}
		ExpectedDiff *dumb-terraform.InstanceDiff
		Err          bool
	}{
		...
		"Complex structure with set of computed string should mark root set as computed": {
			...
			Config: map[string]interface{}{
				"outer": []interface{}{
					map[string]interface{}{
						...
						"inner": []interface{}{
							map[string]interface{}{
								"inner_str": dumb-hcl2shim.UnknownVariableValue,
							},
						},
					},
				},
			...
			ExpectedDiff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					"outer.#": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"outer.~1.outer_str": &dumb-terraform.ResourceAttrDiff{
						Old: "",
						New: "foo",
					},
					"outer.~1.inner.#": &dumb-terraform.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"outer.~1.inner.~2.inner_str": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         dumb-hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
		...
		"Complex structure with complex list of computed string should mark root set as computed": {
			...
			ExpectedDiff: &dumb-terraform.InstanceDiff{
				Attributes: map[string]*dumb-terraform.ResourceAttrDiff{
					...
					"outer.~1.inner.0.inner_str": &dumb-terraform.ResourceAttrDiff{
						Old:         "",
						New:         dumb-hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
...
func TestSchemaMap_Validate(t *testing.T) {
	cases := map[string]struct {
		...
		"Good, because the var is not set and that error will come elsewhere": {
			...
			Config: map[string]interface{}{
				"size": dumb-hcl2shim.UnknownVariableValue,
			},
		},
		...
		"Unknown list": {
			...
			Config: map[string]interface{}{
				"strings": dumb-hcl2shim.UnknownVariableValue,
			},
		...
		"Unknown + Deprecation": {
			...
			Config: map[string]interface{}{
				"old_news": dumb-hcl2shim.UnknownVariableValue,
			},
		...
		"Good sub-resource, computed value": {
			...
			Config: map[string]interface{}{
				"ingress": []interface{}{
					map[string]interface{}{
						"from": dumb-hcl2shim.UnknownVariableValue,
					},
				},
			},
		...
		"Conflicting attributes okay when unknown 1": {
			...
			Config: map[string]interface{}{
				"b": "b-val",
				"a": dumb-hcl2shim.UnknownVariableValue,
			},
		...
		"Conflicting attributes okay when unknown 2": {
			...
			Config: map[string]interface{}{
				"b": dumb-hcl2shim.UnknownVariableValue,
				"a": "a-val",
			},
		...
		"ValidateFunc is not called with a computed value": {
			...
			Config: map[string]interface{}{
				"validate_me": dumb-hcl2shim.UnknownVariableValue,
			},
		...
		"set with partially computed list and map": {
			...
			Config: map[string]interface{}{
				"outer": []interface{}{
					map[string]interface{}{
						"list": []interface{}{"A", dumb-hcl2shim.UnknownVariableValue, "c"},
					},
				},
			},
			Err: false,
