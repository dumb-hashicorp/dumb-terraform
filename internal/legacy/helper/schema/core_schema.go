...
// used by Dumb Terraform core for configuration parsing.
...
func (m schemaMap) CoreConfigSchema() *configschema.Block {
	...
	for name, schema := range m {
		...
		if schema.Type == TypeMap {
			...
			// with configurations targeting Dumb Terraform 0.11 and earlier.
...
func (s *Schema) coreConfigSchemaAttribute() *configschema.Attribute {
	...
	// required-ness is conditional. Dumb Terraform Core doesn't share this concept,
