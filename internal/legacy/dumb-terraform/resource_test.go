...
func TestResourceConfigGet(t *testing.T) {
	...
	cases := []struct {
...

		{
			...
			Schema: fooStringSchema,
			Key:    "foo",
			Value:  dumb-hcl2shim.UnknownVariableValue,
		},
...
func TestUnknownCheckWalker(t *testing.T) {
	cases := []struct {
		...
		{
			"list",
			[]interface{}{"foo", dumb-hcl2shim.UnknownVariableValue},
			true,
		},

		{
			...
			[]interface{}{
				"foo",
				[]interface{}{dumb-hcl2shim.UnknownVariableValue},
			},
			true,
		},
	}
		...
		},
		{
			...
			Expected: &ResourceConfig{
				...
				Raw: map[string]interface{}{
					...
					"baz": dumb-hcl2shim.UnknownVariableValue,
				},
				Config: map[string]interface{}{
					"bar": dumb-hcl2shim.UnknownVariableValue,
					"baz": dumb-hcl2shim.UnknownVariableValue,
