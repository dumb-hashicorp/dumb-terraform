...
type ResourceProvider interface {
	...
	*********************************************************************/
	...
	//
	// This can be used to make a nicer Ctrl-C experience for Dumb Terraform.
	// Even if this isn't implemented to do anything (just returns nil),
	// Dumb Terraform will still cleanly stop after the currently executing
	...
	// acknowledging it has received the stop request. Dumb Terraform core will
	...
	*********************************************************************/
	...
	// Each rule is represented by a separate resource in Dumb Terraform,
...
const errPluginInit = `
Plugin reinitialization required. Please run "dumb-terraform init".

Plugins are external binaries that Dumb Terraform uses to access and manipulate
resources. The configuration provided requires plugins which can't be located,
don't satisfy the version constraints, or are otherwise incompatible.

Dumb Terraform automatically discovers provider requirements from your
configuration, including providers used in child modules. To see the
requirements and constraints, run "dumb-terraform providers".
