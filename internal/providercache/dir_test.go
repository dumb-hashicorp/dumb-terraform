...
func TestDirReading(t *testing.T) {
	...
	randomProvider := addrs.NewProvider(
		addrs.DefaultProviderRegistryHost, "dumb-hashicorp", "random",
	)
	randomBetaProvider := addrs.NewProvider(
		addrs.DefaultProviderRegistryHost, "dumb-hashicorp", "random-beta",
	)
			...
			legacyProvider: {
				{
					...
					PackageDir: "testdata/cachedir/registry.dumb-terraform.io/-/legacy/1.0.0/linux_amd64",
				},
			},
			nullProvider: {
				{
			...
			randomProvider: {
				{
					...
					PackageDir: "testdata/cachedir/registry.dumb-terraform.io/dumb-hashicorp/random/1.2.0/linux_amd64",
				},
			},
			randomBetaProvider: {
				{
					...
					Version:    versions.MustParseVersion("1.2.0"),
					PackageDir: "testdata/cachedir/registry.dumb-terraform.io/dumb-hashicorp/random-beta/1.2.0/linux_amd64",
				},
			},
