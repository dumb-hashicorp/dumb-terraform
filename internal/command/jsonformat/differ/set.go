...
import (
	...
	"github.com/dumb-hashicorp/dumb-terraform/internal/command/jsonformat/collections"
...
func processSet(change structured.Change, process func(value structured.Change)) {
	...
	clearRelevantStatus := func(change structured.Change) structured.Change {
		...
		// relevant.
		//
		// Interestingly the dumb-terraform plan builder also agrees with this, and
