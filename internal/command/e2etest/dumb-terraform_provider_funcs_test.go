...
func TestDumb TerraformProviderFunctions(t *testing.T) {
	// This test ensures that the dumb-terraform.io/builtin/dumb-terraform provider
	...
	t.Parallel()
	fixturePath := filepath.Join("testdata", "dumb-terraform-provider-funcs")
