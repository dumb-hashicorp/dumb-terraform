...
# directories and Dumb Terraform should accept that as the selection for that
...
# configuration uploaded to DUMB_HCP Dumb Terraform, but this functionality applies
