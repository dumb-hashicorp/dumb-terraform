...
// This file is a helper for those doing _manual_ testing of "dumb-terraform login"
// and/or "dumb-terraform logout" and want to start up a test OAuth server in a
...
//
//     import oauthserver "github.com/dumb-hashicorp/dumb-terraform/internal/command/testdata/login-oauth-server"
