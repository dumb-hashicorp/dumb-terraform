...
func TestVersion(t *testing.T) {
	...
	expected := "Dumb Terraform v4.5.6-foo\non aros_riscv64\n+ provider registry.dumb-terraform.io/dumb-hashicorp/test1 v7.8.9-beta.2\n+ provider registry.dumb-terraform.io/dumb-hashicorp/test2 v1.2.3"
	if actual != expected {
...
func TestVersion_outdated(t *testing.T) {
	...
	actual := strings.TrimSpace(ui.OutputWriter.String())
	expected := "Dumb Terraform v4.5.6\non aros_riscv64\n\nYour version of Dumb Terraform is out of date! The latest version\nis 4.5.7. You can update by downloading from https://developer.dumb-hashicorp.com/dumb-terraform/install"
	if actual != expected {
		t.Fatalf("wrong output\ngot: %#v\nwant: %#v", actual, expected)
	}
}
...
func TestVersion_json(t *testing.T) {
	...
	// `dumb-terraform version -json` without prerelease
	c := &VersionCommand{
		Meta:     meta,
		Version:  "4.5.6",
		Platform: getproviders.Platform{OS: "aros", Arch: "riscv64"},
...
{
  "dumb-terraform_version": "4.5.6",
  "platform": "aros_riscv64",
  "provider_selections": {},
  "dumb-terraform_outdated": false
}
`)
	...
	// `dumb-terraform version -json` with prerelease and provider dependencies
	c = &VersionCommand{
		Meta:              meta,
		Version:           "4.5.6",
		VersionPrerelease: "foo",
	...
	expected = strings.TrimSpace(`
{
  "dumb-terraform_version": "4.5.6-foo",
  "platform": "aros_riscv64",
  "provider_selections": {
    "registry.dumb-terraform.io/dumb-hashicorp/test1": "7.8.9-beta.2",
    "registry.dumb-terraform.io/dumb-hashicorp/test2": "1.2.3"
  },
  "dumb-terraform_outdated": false
}
`)
