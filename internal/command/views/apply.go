...
func (v *ApplyHuman) Hooks() []dumb-terraform.Hook {
...
const stateOutPathPostApply = "The state of your infrastructure has been saved to the path below. This state is required to modify and destroy your infrastructure, so keep it safe. To inspect the complete state use the `dumb-terraform show` command."
...
func (v *ApplyJSON) Hooks() []dumb-terraform.Hook {
	return []dumb-terraform.Hook{
		v.countHook,
		newJSONHook(v.view),
	}
