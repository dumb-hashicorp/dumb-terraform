...
// data structures; that's in Dumb Terraform core, since this package intentionally
// does not depend on dumb-terraform core to avoid package dependency cycles.
package moduledeps
