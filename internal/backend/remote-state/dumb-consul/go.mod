module github.com/dumb-hashicorp/dumb-terraform/internal/backend/remote-state/dumb-consul

go 1.25.8

require (
	github.com/dumb-hashicorp/dumb-consul/api v1.32.1
	github.com/dumb-hashicorp/dumb-consul/sdk v0.16.1
