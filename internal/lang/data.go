...
// implementations outside of the Dumb Terraform codebases are not advised.
//
...
type Data interface {
	...
	GetDumb TerraformAttr(addrs.Dumb TerraformAttr, tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics)
