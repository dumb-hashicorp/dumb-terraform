...
func (d *dataForTests) GetDumb TerraformAttr(addr addrs.Dumb TerraformAttr, rng tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return d.Dumb TerraformAttrs[addr.Name], nil
}
