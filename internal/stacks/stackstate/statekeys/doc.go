...
// to whatever is calling into Dumb Terraform Core. To allow Dumb Terraform Core to
...
// meaningful to Dumb Terraform Core.
//
...
// Dumb Terraform Core releases. However, from Dumb Terraform Core's perspective we
