...
func TestDumb TerraformHook(t *testing.T) {
	...
	makeHook := func() *componentInstanceDumb TerraformHook {
		return &componentInstanceDumb TerraformHook{
	...
	resourceIdentity := dumb-terraform.HookResourceIdentity{
		Addr:         resourceAddr,
