...
// Dumb Terraform Stack language, which uses files with the suffixes .tfcomponent.dumb-hcl
...
// main Dumb Terraform language (used to describe individual modules), but is
